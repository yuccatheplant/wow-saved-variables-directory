	...
	["0516220457Kq71r"] = {
		["IN"] = {
			["doc"] = {
				...
				["PA"] = {
					{
						["TX"] = "{h1:c}Kylania's will{/h1}\nI hereby give all of my possesions to Yenuthile Spirithout.\n\nKylania Sunborne",
					}, -- [1]
					{
					}, -- [2]
				},
		...
		["securityLevel"] = 3,
		["MD"] = {
			["CD"] = "16/05/21 22:04:57",
			["CB"] = "Yenuthie-ArgentDawn",
			["V"] = 8,
			["LO"] = "en",
			["SD"] = "16/05/21 22:10:30",
			["tV"] = 1026,
			["dV"] = "1.4",
			["MO"] = "NO",
			["SB"] = "Yenuthie-ArgentDawn",
		},
		["CO"] = {
			["OI"] = false,
			["MW"] = 0,
...
TRP3_Exchange_DB = {
	["0419204257wizik"] = {
		...
		["MD"] = {
			["CD"] = "19/04/21 20:42:57",
			["SB"] = "Koruz-ArgentDawn",
			["V"] = 4,
			["SD"] = "19/04/21 22:12:02",
			["tV"] = 1026,
			["dV"] = "1.4",
			["MO"] = "NO",
			["LO"] = "en",
	...
	["042100145564xVd"] = {
		...
		["MD"] = {
			["SD"] = "21/04/21 00:18:46",
			["SB"] = "Koruz-ArgentDawn",
			["V"] = 2,
			["CB"] = "Koruz-ArgentDawn",
			["CD"] = "21/04/21 00:14:55",
			["MO"] = "NO",
			["tV"] = 1026,
			["dV"] = "1.4",
			["LO"] = "en",
		...
		["securityLevel"] = 3,
		["BA"] = {
			["DE"] = "Some engraving can be seen on the side.",
			["PS"] = 1186,
	...
	["04191950437OgCA"] = {
		...
		["BA"] = {
			["DE"] = "Inscribed on it - \"Darkheart Company, Items extraordinare\"",
			["PS"] = 1186,
			["US"] = false,
			["CO"] = false,
			["NA"] = "A Card",
			...
			["WE"] = 25,
			["DS"] = 1203,
			["IC"] = "item_hearthstone_card_purple",
			["UN"] = false,
			["SB"] = false,
			["QE"] = false,
			["CT"] = false,
		...
		["MD"] = {
			["CD"] = "19/04/21 19:50:43",
			["CB"] = "Koruz-ArgentDawn",
			["V"] = 3,
			["SD"] = "19/04/21 19:58:17",
			["tV"] = 1026,
			["dV"] = "1.4",
			["MO"] = "NO",
			["LO"] = "en",
	...
	["0421000045iz3hJ"] = {
		...
		["BA"] = {
			["DE"] = "It's long and hard. Also made from fine wood.",
			["PS"] = 1186,
			["IC"] = "inv_misc_pipe_01",
			["CO"] = false,
			["NA"] = "Koruz's Pipe",
		...
		["MD"] = {
			...
			["CB"] = "Koruz-ArgentDawn",
			["V"] = 3,
			["CD"] = "21/04/21 00:00:45",
			["tV"] = 1026,
			["dV"] = "1.4",
			["MO"] = "NO",
			["SD"] = "21/04/21 00:11:59",
			["SB"] = "Koruz-ArgentDawn",
		},
		["CO"] = {
			["OI"] = false,
	...
	["0515223024qC52v"] = {
		["IN"] = {
			["doc"] = {
				...
				["PA"] = {
					{
						["TX"] = ".... Kalimdor. That's where it seems to be at least, not sure yet where.\nI ruled outland out of the question, same as Northren and Pandaria. Kalimdor is most likely, although i have not eliminated all leads in Eastern Kingdoms, i must contact some of my old sources and....\n\n(rest of the page seems unreadable)",
					}, -- [1]
					{
						["TX"] = "....of a guardian. not sure what it may be, but i better prepare my equipment, don't wanna be caught off-guard. Outside of that, most legends say that the only thing to worry about there is that damned thing, as the area around the well is said to be tranquil. Guess i have to get some resources prepared....\n\n(rest of the page seems unreadable)",
					}, -- [2]
					{
						["TX"] = "Dammit. My head is getting more and more cluttered by the day, and i start to notice that i a losing time. i feel something scratching in my bloody head, i have to hurry. i Think i'll tell Lucius about it, need a backup.\n\n(rest of the page seems unreadable)",
					}, -- [3]
					{
						["TX"] = ".... I have found some leads on the current location of the well, for now the list of people that i heard the names of\n\n-Baron of the Bay\n-Master of the Drink\n-Forsaken of Light's hope\n-Inkeep of Thrallmar\n\nSome of them heard rumors, i think i outta pay them a visit.....\n\n(rest of the page seems unreadable)",
					}, -- [4]
					{
						["TX"] = "I.... i don't know.... what's happening anymore. The world seems wrong.... my mind.... can't think. William. I need that plague, this world will be free. DAMMIT WHAT AM I WRITING WHAT IS HAPPENING I CAN'T BLOODY THINK NORMAL..... i....i am losing it. Whoever finds this.... i hope something stops me. i think i am at the edge, and soon whatever is clawing at the back of my head will be the thing that controls me. Luci, if you are reading this, I am sorry, Hex, i am sorry, Kyla, I am sorry.... to all of Darkheart and Azeroth, i am sorry. I cannot hold Much longer. Farewell.\n\nALL LIFE MUST END.",
					}, -- [5]
				},
				["BCK"] = 8,
				["MD"] = {
		...
		["BA"] = {
			["DE"] = "Leather journal written by Koruz",
			["PS"] = 1186,
			["US"] = true,
			["CO"] = false,
			["NA"] = "Koruz's Journal Part 1",
			["ST"] = false,
			["QA"] = 5,
			["SB"] = false,
			["UN"] = false,
...
TRP3_Security = {
	...
	["sender"] = {
		["0419204257wizik"] = "Koruz-ArgentDawn",
		...
		["042100145564xVd"] = "Koruz-ArgentDawn",
		["04191950437OgCA"] = "Koruz-ArgentDawn",
		["0314164253oakUK"] = "Darenin-ArgentDawn",
		["0421000045iz3hJ"] = "Koruz-ArgentDawn",
		["01301645396yvma"] = "Looradeii-ArgentDawn",
		["1124105229jy4At"] = "Barktender-ArgentDawn",
		["0515223024qC52v"] = "Mothradamus-ArgentDawn",
	},
	["global"] = {
